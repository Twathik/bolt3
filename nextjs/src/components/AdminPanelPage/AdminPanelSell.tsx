...
import UserProfileButton from "../WebAppIndexComponents/UserProfileButton/UserProfileButton";
import Link from "next/link";
import { usePathname } from "next/navigation";
import Image from "next/image";

interface AdminPanelSellPropsInterface {
  children: React.ReactNode;
}

export default function AdminPanelSell({
  children,
}: AdminPanelSellPropsInterface) {
