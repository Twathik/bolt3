...
import { INSERT_PRESCRIPTION_LAYOUT_COMMAND } from "@/components/ClinicalEvents/Prescription/PrescriptionEditor/PrescriptionLayout/PrescriptionLayoutPlugin";
...
export default function InsertLayoutDialog({
  ...
  const onClick = () => {
    activeEditor.dispatchCommand(INSERT_PRESCRIPTION_LAYOUT_COMMAND, null);
