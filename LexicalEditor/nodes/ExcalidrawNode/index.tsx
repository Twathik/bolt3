...
export type SerializedExcalidrawNode = lexical.Spread<
  {
    data: string;
  },
...
function convertExcalidrawElement(
  domNode: HTMLElement
): lexical.DOMConversionOutput | null {
...
export class ExcalidrawNode extends DecoratorNode<JSX.Element> {
  ...
  constructor(data = "[]", key?: lexical.NodeKey) {
    super(key);
    this.__data = data;
  }
  ...
  static importDOM(): lexical.DOMConversionMap<HTMLSpanElement> | null {
    return {
  ...
  exportDOM(editor: lexical.LexicalEditor): lexical.DOMExportOutput {
