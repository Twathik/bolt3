...
import type function_WorkingListsLinkExam from "../../../wundergraph/.wundergraph/operations/WorkingLists/linkExam";
import type function_WorkingListsRefreshLinkExam from "../../../wundergraph/.wundergraph/operations/WorkingLists/refreshLinkExam";
...
export const mainDb_DisplayTypeEnum = {
	dicom: "dicom",
	main: "main",
} as const;

export type mainDb_DisplayTypeEnumValues = (typeof mainDb_DisplayTypeEnum)[keyof typeof mainDb_DisplayTypeEnum];
...
export interface ModalityUpdatedModalitySubscriptionInput {
	id: string;
}

export interface SecondaryDisplayTriggerChangeInput {
	id: string;
	displayType: mainDb_DisplayTypeEnumValues;
	payload: string;
}
...
export interface WorkingListsCurrentPatientWorkingListSubscriptionInput {
	clinicalEventId: string;
}
...
export interface ModalityUpdatedModalitySubscriptionInputInternal {
	id: string;
}

export interface SecondaryDisplayChangeSubscriptionInputInternal {
	userId: string;
}

export interface SecondaryDisplayTriggerChangeInputInternal {
	id: string;
	displayType: mainDb_DisplayTypeEnumValues;
	payload: string;
	userId: string;
...
export interface WorkingListsCurrentPatientWorkingListSubscriptionInputInternal {
	clinicalEventId: string;
}
...
export interface ModalityUpdatedModalitySubscriptionInputInjected {
	id: string;
}

export interface SecondaryDisplayChangeSubscriptionInputInjected {
	userId: string;
}

export interface SecondaryDisplayTriggerChangeInputInjected {
	id: string;
	displayType: mainDb_DisplayTypeEnumValues;
	payload: string;
	userId: string;
...
export interface WorkingListsCurrentPatientWorkingListSubscriptionInputInjected {
	clinicalEventId: string;
}
...
export interface ModalityUpdatedModalitySubscriptionResponse {
	data?: ModalityUpdatedModalitySubscriptionResponseData;
	errors?: GraphQLError[];
}

export interface SecondaryDisplayChangeSubscriptionResponse {
	data?: SecondaryDisplayChangeSubscriptionResponseData;
	errors?: GraphQLError[];
}

export interface SecondaryDisplayTriggerChangeResponse {
	data?: SecondaryDisplayTriggerChangeResponseData;
	errors?: GraphQLError[];
}
...
export interface WorkingListsCurrentPatientWorkingListSubscriptionResponse {
	data?: WorkingListsCurrentPatientWorkingListSubscriptionResponseData;
	errors?: GraphQLError[];
}
...
export interface ModalityUpdatedModalitySubscriptionResponseData {
	mainDb_getUpdatedModalitySubscription: {
		id: string;
		modalityAETitle: string;
		modalityIpAddress: string;
		modalityPseudo?: string;
...
export interface SecondaryDisplayChangeSubscriptionResponseData {
	mainDb_changeSecondaryDisplaySubscription: {
		id: string;
		displayType: "dicom" | "main";
		payload: string;
	};
}

export interface SecondaryDisplayTriggerChangeResponseData {
	mainDb_triggerChangeSecondaryDisplaySubscription: boolean;
}
...
export interface WorkingListsCurrentPatientWorkingListSubscriptionResponseData {
	mainDb_currentWorkingListSubscription: {
		id: string;
		modality: {
			id: string;
			modalityPseudo?: string;
