  ...
  return (
    <DropDown
      ...
      <DropDownItem
        ...
        <span className="text">Liste non numérotée</span>
      </DropDownItem>
      <DropDownItem
  ...
  return (
    <DropDown
      ...
      <DropDownItem
        ...
        <span className="text">Centrer le text</span>
      </DropDownItem>
      <DropDownItem
        onClick={() => {
      ...
      <DropDownItem
        ...
        <span className="text">Diminuer le retrait</span>
      </DropDownItem>
      <DropDownItem
        onClick={() => {
        ...
        <span className="text">Augmenter le retrait</span>
      </DropDownItem>
    </DropDown>
  );
}
        ...
        <>
          ...
          <DropDown
            ...
            <DropDownItem
              ...
              <span className="text">Barrer</span>
            </DropDownItem>
            <DropDownItem
              onClick={() => {
            ...
            <DropDownItem
              ...
              <span className="text">Effacer Mise en forme</span>
            </DropDownItem>
          </DropDown>
          <Divider />
          {/*  {rootType === "table" && (
          ...
          <DropDown
            ...
            <DropDownItem
              ...
              <span className="text">Ligne horizontale</span>
            </DropDownItem>
            <DropDownItem
              onClick={() => {
              ...
              <span className="text">Saut de page</span>
            </DropDownItem>
            <DropDownItem
              onClick={() => {
            ...
            <DropDownItem
              ...
              className="item">
              <i className="icon image" />
              <span className="text">Image alignée</span>
            </DropDownItem>
            {/* <DropDownItem
              onClick={() =>
                insertGifOnClick({
            ...
            >
              ...
              <span className="text">Shemat</span>
            </DropDownItem> */}
            <DropDownItem
              onClick={() => {
                showModal("Insérer tableau", (onClose) => (
                  <InsertTableDialog
                    activeEditor={activeEditor}
                    onClose={onClose}
                  />
            ...
            >
              <i className="icon table" />
              <span className="text">Tableau (Experimental)</span>
            </DropDownItem> */}
            {/* <DropDownItem
              onClick={() => {
            ...
            <DropDownItem
              onClick={() => {
                showModal("Inserer des colonnes de texte", (onClose) => (
                  <InsertLayoutDialog
                    activeEditor={activeEditor}
                    onClose={onClose}
                  />
              ...
              <span className="text">Colonnes de texte</span>
            </DropDownItem>
