...
import BarCode from "../../../../ClinicalEvents/Prescription/PrescriptionEditor/PrescriptionPdf/BarCode";
import { Button } from "@/ui/components/ui/button";

registerFonts();

function EditorToPdf({ size }: { size: ComponentProps<typeof Page>["size"] }) {
    ...
    <>
      <Sheet>
        <SheetTrigger asChild>
          <Button variant="secondary">Génerer le PDF</Button>
        </SheetTrigger>
            ...
            <SheetDescription
              ...
              <PDFViewer
                ...
                <Document
                  ...
                  author="Tak"
                  producer="Bolt">
                  <Page size={size} wrap style={tw("py-10 px-5")}>
