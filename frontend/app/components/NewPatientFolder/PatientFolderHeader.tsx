...
import { PatientFolderNavigationMenu } from "../PatientFolder/Header/AppMenu/PatientFolderNavigationMenu";
            ...
            <div className="relative flex h-16 items-center justify-between">
              ...
              <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                <div className="flex flex-shrink-0 items-center">
                  <strong className="text-yellow-400">BOLT3</strong>
                </div>
                <div className="hidden sm:ml-6 sm:block">
                  <div className="flex space-x-4">
                    <PatientFolderNavigationMenu />
                  </div>
                </div>
              </div>
              <PatientInformation />
              <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                ...
                <Menu as="div" className="relative ml-3">
                  ...
                  <Transition
                    ...
                    <Menu.Items className="absolute right-0 mt-2 w-60 origin-top-right rounded-md bg-white py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none z-[10000]">
                      <Menu.Item>
