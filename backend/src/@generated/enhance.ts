...
const modelsInfo = {
  ...
  Setting: ["id", "allowedMobileDevices_doctors", "allowedMobileDevices_secretary", "allowedDICOMmodalities"],
...
const outputsInfo = {
  ...
  SettingGroupBy: ["id", "allowedMobileDevices_doctors", "allowedMobileDevices_secretary", "allowedDICOMmodalities", "_count", "_avg", "_sum", "_min", "_max"],
  ...
  SettingCountAggregate: ["id", "allowedMobileDevices_doctors", "allowedMobileDevices_secretary", "allowedDICOMmodalities", "_all"],
...
const inputsInfo = {
  ...
  SettingWhereInput: ["AND", "OR", "NOT", "id", "allowedMobileDevices_doctors", "allowedMobileDevices_secretary", "allowedDICOMmodalities"],
  SettingOrderByWithRelationInput: ["id", "allowedMobileDevices_doctors", "allowedMobileDevices_secretary", "allowedDICOMmodalities"],
  SettingWhereUniqueInput: ["id", "AND", "OR", "NOT", "allowedMobileDevices_doctors", "allowedMobileDevices_secretary", "allowedDICOMmodalities"],
  SettingOrderByWithAggregationInput: ["id", "allowedMobileDevices_doctors", "allowedMobileDevices_secretary", "allowedDICOMmodalities", "_count", "_avg", "_max", "_min", "_sum"],
  SettingScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id", "allowedMobileDevices_doctors", "allowedMobileDevices_secretary", "allowedDICOMmodalities"],
  ...
  SettingCreateInput: ["id", "allowedMobileDevices_doctors", "allowedMobileDevices_secretary", "allowedDICOMmodalities"],
  SettingUpdateInput: ["id", "allowedMobileDevices_doctors", "allowedMobileDevices_secretary", "allowedDICOMmodalities"],
  SettingCreateManyInput: ["id", "allowedMobileDevices_doctors", "allowedMobileDevices_secretary", "allowedDICOMmodalities"],
  SettingUpdateManyMutationInput: ["id", "allowedMobileDevices_doctors", "allowedMobileDevices_secretary", "allowedDICOMmodalities"],
  ...
  SettingCountOrderByAggregateInput: ["id", "allowedMobileDevices_doctors", "allowedMobileDevices_secretary", "allowedDICOMmodalities"],
