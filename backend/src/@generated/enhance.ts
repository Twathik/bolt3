...
const inputsInfo = {
  ...
  PatientWhereInput: ["AND", "OR", "NOT", "id", "lastName", "firstName", "ddn", "sexe", "nTel", "address", "createdAt", "updated", "deleted", "onTrash", "informationsConfirmed", "ConsultationList"],
  PatientOrderByWithRelationInput: ["id", "lastName", "firstName", "ddn", "sexe", "nTel", "address", "createdAt", "updated", "deleted", "onTrash", "informationsConfirmed", "ConsultationList"],
  PatientWhereUniqueInput: ["id", "AND", "OR", "NOT", "lastName", "firstName", "ddn", "sexe", "nTel", "address", "createdAt", "updated", "deleted", "onTrash", "informationsConfirmed", "ConsultationList"],
  ...
  PatientCreateInput: ["id", "lastName", "firstName", "ddn", "sexe", "nTel", "address", "createdAt", "updated", "deleted", "onTrash", "informationsConfirmed", "ConsultationList"],
  PatientUpdateInput: ["id", "lastName", "firstName", "ddn", "sexe", "nTel", "address", "createdAt", "updated", "deleted", "onTrash", "informationsConfirmed", "ConsultationList"],
  ...
  PatientCreateWithoutConsultationListInput: ["id", "lastName", "firstName", "ddn", "sexe", "nTel", "address", "createdAt", "updated", "deleted", "onTrash", "informationsConfirmed"],
  ...
  PatientUpdateWithoutConsultationListInput: ["id", "lastName", "firstName", "ddn", "sexe", "nTel", "address", "createdAt", "updated", "deleted", "onTrash", "informationsConfirmed"],
