...
const crudResolversMap = {
  ...
  PatientScannedDocument: crudResolvers.PatientScannedDocumentCrudResolver,
...
const actionResolversMap = {
  ...
  PatientScannedDocument: {
    aggregatePatientScannedDocument: actionResolvers.AggregatePatientScannedDocumentResolver,
    createManyPatientScannedDocument: actionResolvers.CreateManyPatientScannedDocumentResolver,
    createOnePatientScannedDocument: actionResolvers.CreateOnePatientScannedDocumentResolver,
    deleteManyPatientScannedDocument: actionResolvers.DeleteManyPatientScannedDocumentResolver,
    deleteOnePatientScannedDocument: actionResolvers.DeleteOnePatientScannedDocumentResolver,
    findFirstPatientScannedDocument: actionResolvers.FindFirstPatientScannedDocumentResolver,
    findFirstPatientScannedDocumentOrThrow: actionResolvers.FindFirstPatientScannedDocumentOrThrowResolver,
    patientScannedDocuments: actionResolvers.FindManyPatientScannedDocumentResolver,
    patientScannedDocument: actionResolvers.FindUniquePatientScannedDocumentResolver,
    getPatientScannedDocument: actionResolvers.FindUniquePatientScannedDocumentOrThrowResolver,
    groupByPatientScannedDocument: actionResolvers.GroupByPatientScannedDocumentResolver,
    updateManyPatientScannedDocument: actionResolvers.UpdateManyPatientScannedDocumentResolver,
    updateOnePatientScannedDocument: actionResolvers.UpdateOnePatientScannedDocumentResolver,
    upsertOnePatientScannedDocument: actionResolvers.UpsertOnePatientScannedDocumentResolver
  },
  DocumentStore: {
...
const crudResolversInfo = {
  ...
  PatientScannedDocument: ["aggregatePatientScannedDocument", "createManyPatientScannedDocument", "createOnePatientScannedDocument", "deleteManyPatientScannedDocument", "deleteOnePatientScannedDocument", "findFirstPatientScannedDocument", "findFirstPatientScannedDocumentOrThrow", "patientScannedDocuments", "patientScannedDocument", "getPatientScannedDocument", "groupByPatientScannedDocument", "updateManyPatientScannedDocument", "updateOnePatientScannedDocument", "upsertOnePatientScannedDocument"],
...
const argsInfo = {
  ...
  AggregatePatientScannedDocumentArgs: ["where", "orderBy", "cursor", "take", "skip"],
  CreateManyPatientScannedDocumentArgs: ["data", "skipDuplicates"],
  CreateOnePatientScannedDocumentArgs: ["data"],
  DeleteManyPatientScannedDocumentArgs: ["where"],
  DeleteOnePatientScannedDocumentArgs: ["where"],
  FindFirstPatientScannedDocumentArgs: ["where", "orderBy", "cursor", "take", "skip", "distinct"],
  FindFirstPatientScannedDocumentOrThrowArgs: ["where", "orderBy", "cursor", "take", "skip", "distinct"],
  FindManyPatientScannedDocumentArgs: ["where", "orderBy", "cursor", "take", "skip", "distinct"],
  FindUniquePatientScannedDocumentArgs: ["where"],
  FindUniquePatientScannedDocumentOrThrowArgs: ["where"],
  GroupByPatientScannedDocumentArgs: ["where", "orderBy", "by", "having", "take", "skip"],
  UpdateManyPatientScannedDocumentArgs: ["data", "where"],
  UpdateOnePatientScannedDocumentArgs: ["data", "where"],
  UpsertOnePatientScannedDocumentArgs: ["where", "create", "update"],
...
const relationResolversMap = {
  ...
  PatientScannedDocument: relationResolvers.PatientScannedDocumentRelationsResolver,
  DocumentStore: relationResolvers.DocumentStoreRelationsResolver,
...
const relationResolversInfo = {
  User: ["WorkingList", "ClinicalEvent"],
  Patient: ["ConsultationList", "ClinicalEvent", "WorkingList", "DocumentStore", "PatientScanedDocument"],
  PatientScannedDocument: ["patient"],
  DocumentStore: ["patient"],
...
const modelsInfo = {
  ...
  Setting: ["id", "allowedMobileDevices_doctors", "allowedMobileDevices_secretary", "allowedDICOMmodalities", "allowedEventTypes", "documentTemplateConfiguration"],
  MobileDevice: ["id", "uuid", "accessToken", "mobileDeviceType", "expireAt", "connected"],
  Patient: ["id", "lastName", "firstName", "ddn", "sexe", "nTel", "address", "height", "weight", "createdAt", "updated", "deleted", "onTrash", "informationsConfirmed", "patientAvatar"],
  PatientScannedDocument: ["id", "documentCollectionName", "documentCollectionUrls", "documentCollectionDate", "createdAt", "patientId"],
  DocumentStore: ["id", "patientId", "patientDocumentType", "content", "textContent"],
  ConsultationList: ["id", "patientId", "active", "consultationDate", "createdAt", "updatedAt"],
  ClinicalEvent: ["id", "eventType", "eventCategory", "userId", "patientId", "createdAt", "updatedAt", "deleted", "deletedReport", "deletedByUserId", "dicom", "dicomId", "clinicalDiagnosticId"],
  Prescription: ["id", "clinicalEventId", "savedPrescription", "createdAt", "updatedAt"],
  DocumentTemplate: ["id", "templateName", "evenTemplateUrl", "eventDoxTemplate", "oddTemplateUrl", "oddDoxTemplate", "templateSpeciality", "createdAt"],
...
const outputsInfo = {
  ...
  SettingGroupBy: ["id", "allowedMobileDevices_doctors", "allowedMobileDevices_secretary", "allowedDICOMmodalities", "allowedEventTypes", "documentTemplateConfiguration", "_count", "_avg", "_sum", "_min", "_max"],
  ...
  PatientGroupBy: ["id", "lastName", "firstName", "ddn", "sexe", "nTel", "address", "height", "weight", "createdAt", "updated", "deleted", "onTrash", "informationsConfirmed", "patientAvatar", "_count", "_avg", "_sum", "_min", "_max"],
  AggregatePatientScannedDocument: ["_count", "_min", "_max"],
  PatientScannedDocumentGroupBy: ["id", "documentCollectionName", "documentCollectionUrls", "documentCollectionDate", "createdAt", "patientId", "_count", "_min", "_max"],
  AggregateDocumentStore: ["_count", "_min", "_max"],
  DocumentStoreGroupBy: ["id", "patientId", "patientDocumentType", "content", "textContent", "_count", "_min", "_max"],
  AggregateConsultationList: ["_count", "_min", "_max"],
  ConsultationListGroupBy: ["id", "patientId", "active", "consultationDate", "createdAt", "updatedAt", "_count", "_min", "_max"],
  AggregateClinicalEvent: ["_count", "_min", "_max"],
  ClinicalEventGroupBy: ["id", "eventType", "eventCategory", "userId", "patientId", "createdAt", "updatedAt", "deleted", "deletedReport", "deletedByUserId", "dicom", "dicomId", "clinicalDiagnosticId", "_count", "_min", "_max"],
  ...
  AggregateDocumentTemplate: ["_count", "_avg", "_sum", "_min", "_max"],
  DocumentTemplateGroupBy: ["id", "templateName", "evenTemplateUrl", "eventDoxTemplate", "oddTemplateUrl", "oddDoxTemplate", "templateSpeciality", "createdAt", "_count", "_avg", "_sum", "_min", "_max"],
  ...
  UserCount: ["WorkingList", "ClinicalEvent"],
  ...
  SettingCountAggregate: ["id", "allowedMobileDevices_doctors", "allowedMobileDevices_secretary", "allowedDICOMmodalities", "allowedEventTypes", "documentTemplateConfiguration", "_all"],
  ...
  SettingMinAggregate: ["id", "allowedMobileDevices_doctors", "allowedMobileDevices_secretary", "allowedDICOMmodalities", "documentTemplateConfiguration"],
  SettingMaxAggregate: ["id", "allowedMobileDevices_doctors", "allowedMobileDevices_secretary", "allowedDICOMmodalities", "documentTemplateConfiguration"],
  ...
  PatientCount: ["ConsultationList", "ClinicalEvent", "WorkingList", "DocumentStore", "PatientScanedDocument"],
  PatientCountAggregate: ["id", "lastName", "firstName", "ddn", "sexe", "nTel", "address", "height", "weight", "createdAt", "updated", "deleted", "onTrash", "informationsConfirmed", "patientAvatar", "_all"],
  PatientAvgAggregate: ["height", "weight"],
  PatientSumAggregate: ["height", "weight"],
  PatientMinAggregate: ["id", "lastName", "firstName", "ddn", "sexe", "nTel", "address", "height", "weight", "createdAt", "updated", "deleted", "onTrash", "informationsConfirmed", "patientAvatar"],
  PatientMaxAggregate: ["id", "lastName", "firstName", "ddn", "sexe", "nTel", "address", "height", "weight", "createdAt", "updated", "deleted", "onTrash", "informationsConfirmed", "patientAvatar"],
  PatientScannedDocumentCountAggregate: ["id", "documentCollectionName", "documentCollectionUrls", "documentCollectionDate", "createdAt", "patientId", "_all"],
  PatientScannedDocumentMinAggregate: ["id", "documentCollectionName", "documentCollectionDate", "createdAt", "patientId"],
  PatientScannedDocumentMaxAggregate: ["id", "documentCollectionName", "documentCollectionDate", "createdAt", "patientId"],
  DocumentStoreCountAggregate: ["id", "patientId", "patientDocumentType", "content", "textContent", "_all"],
  DocumentStoreMinAggregate: ["id", "patientId", "patientDocumentType", "content", "textContent"],
  DocumentStoreMaxAggregate: ["id", "patientId", "patientDocumentType", "content", "textContent"],
  ConsultationListCountAggregate: ["id", "patientId", "active", "consultationDate", "createdAt", "updatedAt", "_all"],
  ConsultationListMinAggregate: ["id", "patientId", "active", "consultationDate", "createdAt", "updatedAt"],
  ConsultationListMaxAggregate: ["id", "patientId", "active", "consultationDate", "createdAt", "updatedAt"],
  ClinicalEventCount: ["WorkingList"],
  ClinicalEventCountAggregate: ["id", "eventType", "eventCategory", "userId", "patientId", "createdAt", "updatedAt", "deleted", "deletedReport", "deletedByUserId", "dicom", "dicomId", "clinicalDiagnosticId", "_all"],
  ClinicalEventMinAggregate: ["id", "eventType", "eventCategory", "userId", "patientId", "createdAt", "updatedAt", "deleted", "deletedReport", "deletedByUserId", "dicom", "dicomId", "clinicalDiagnosticId"],
  ClinicalEventMaxAggregate: ["id", "eventType", "eventCategory", "userId", "patientId", "createdAt", "updatedAt", "deleted", "deletedReport", "deletedByUserId", "dicom", "dicomId", "clinicalDiagnosticId"],
  ...
  DocumentTemplateCountAggregate: ["id", "templateName", "evenTemplateUrl", "eventDoxTemplate", "oddTemplateUrl", "oddDoxTemplate", "templateSpeciality", "createdAt", "_all"],
  DocumentTemplateAvgAggregate: ["id"],
  DocumentTemplateSumAggregate: ["id"],
  DocumentTemplateMinAggregate: ["id", "templateName", "evenTemplateUrl", "eventDoxTemplate", "oddTemplateUrl", "oddDoxTemplate", "templateSpeciality", "createdAt"],
  DocumentTemplateMaxAggregate: ["id", "templateName", "evenTemplateUrl", "eventDoxTemplate", "oddTemplateUrl", "oddDoxTemplate", "templateSpeciality", "createdAt"],
...
const inputsInfo = {
  UserWhereInput: ["AND", "OR", "NOT", "id", "email", "userId", "lastName", "firstName", "fullName", "avatarUrl", "role", "phoneNumbers", "lastConnection", "searchApiKeyId", "searchApiKey", "editorKey", "createdAt", "WorkingList", "ClinicalEvent"],
  UserOrderByWithRelationInput: ["id", "email", "userId", "lastName", "firstName", "fullName", "avatarUrl", "role", "phoneNumbers", "lastConnection", "searchApiKeyId", "searchApiKey", "editorKey", "createdAt", "WorkingList", "ClinicalEvent"],
  UserWhereUniqueInput: ["id", "email", "userId", "AND", "OR", "NOT", "lastName", "firstName", "fullName", "avatarUrl", "role", "phoneNumbers", "lastConnection", "searchApiKeyId", "searchApiKey", "editorKey", "createdAt", "WorkingList", "ClinicalEvent"],
  ...
  SettingWhereInput: ["AND", "OR", "NOT", "id", "allowedMobileDevices_doctors", "allowedMobileDevices_secretary", "allowedDICOMmodalities", "allowedEventTypes", "documentTemplateConfiguration"],
  SettingOrderByWithRelationInput: ["id", "allowedMobileDevices_doctors", "allowedMobileDevices_secretary", "allowedDICOMmodalities", "allowedEventTypes", "documentTemplateConfiguration"],
  SettingWhereUniqueInput: ["id", "AND", "OR", "NOT", "allowedMobileDevices_doctors", "allowedMobileDevices_secretary", "allowedDICOMmodalities", "allowedEventTypes", "documentTemplateConfiguration"],
  SettingOrderByWithAggregationInput: ["id", "allowedMobileDevices_doctors", "allowedMobileDevices_secretary", "allowedDICOMmodalities", "allowedEventTypes", "documentTemplateConfiguration", "_count", "_avg", "_max", "_min", "_sum"],
  SettingScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id", "allowedMobileDevices_doctors", "allowedMobileDevices_secretary", "allowedDICOMmodalities", "allowedEventTypes", "documentTemplateConfiguration"],
  ...
  PatientWhereInput: ["AND", "OR", "NOT", "id", "lastName", "firstName", "ddn", "sexe", "nTel", "address", "height", "weight", "createdAt", "updated", "deleted", "onTrash", "informationsConfirmed", "patientAvatar", "ConsultationList", "ClinicalEvent", "WorkingList", "DocumentStore", "PatientScanedDocument"],
  PatientOrderByWithRelationInput: ["id", "lastName", "firstName", "ddn", "sexe", "nTel", "address", "height", "weight", "createdAt", "updated", "deleted", "onTrash", "informationsConfirmed", "patientAvatar", "ConsultationList", "ClinicalEvent", "WorkingList", "DocumentStore", "PatientScanedDocument"],
  PatientWhereUniqueInput: ["id", "AND", "OR", "NOT", "lastName", "firstName", "ddn", "sexe", "nTel", "address", "height", "weight", "createdAt", "updated", "deleted", "onTrash", "informationsConfirmed", "patientAvatar", "ConsultationList", "ClinicalEvent", "WorkingList", "DocumentStore", "PatientScanedDocument"],
  PatientOrderByWithAggregationInput: ["id", "lastName", "firstName", "ddn", "sexe", "nTel", "address", "height", "weight", "createdAt", "updated", "deleted", "onTrash", "informationsConfirmed", "patientAvatar", "_count", "_avg", "_max", "_min", "_sum"],
  PatientScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id", "lastName", "firstName", "ddn", "sexe", "nTel", "address", "height", "weight", "createdAt", "updated", "deleted", "onTrash", "informationsConfirmed", "patientAvatar"],
  PatientScannedDocumentWhereInput: ["AND", "OR", "NOT", "id", "documentCollectionName", "documentCollectionUrls", "documentCollectionDate", "createdAt", "patientId", "patient"],
  PatientScannedDocumentOrderByWithRelationInput: ["id", "documentCollectionName", "documentCollectionUrls", "documentCollectionDate", "createdAt", "patientId", "patient"],
  PatientScannedDocumentWhereUniqueInput: ["id", "AND", "OR", "NOT", "documentCollectionName", "documentCollectionUrls", "documentCollectionDate", "createdAt", "patientId", "patient"],
  PatientScannedDocumentOrderByWithAggregationInput: ["id", "documentCollectionName", "documentCollectionUrls", "documentCollectionDate", "createdAt", "patientId", "_count", "_max", "_min"],
  PatientScannedDocumentScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id", "documentCollectionName", "documentCollectionUrls", "documentCollectionDate", "createdAt", "patientId"],
  DocumentStoreWhereInput: ["AND", "OR", "NOT", "id", "patientId", "patientDocumentType", "content", "textContent", "patient"],
  DocumentStoreOrderByWithRelationInput: ["id", "patientId", "patientDocumentType", "content", "textContent", "patient"],
  DocumentStoreWhereUniqueInput: ["id", "patientId_patientDocumentType", "AND", "OR", "NOT", "patientId", "patientDocumentType", "content", "textContent", "patient"],
  DocumentStoreOrderByWithAggregationInput: ["id", "patientId", "patientDocumentType", "content", "textContent", "_count", "_max", "_min"],
  DocumentStoreScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id", "patientId", "patientDocumentType", "content", "textContent"],
  ConsultationListWhereInput: ["AND", "OR", "NOT", "id", "patientId", "active", "consultationDate", "createdAt", "updatedAt", "patient"],
  ConsultationListOrderByWithRelationInput: ["id", "patientId", "active", "consultationDate", "createdAt", "updatedAt", "patient"],
  ConsultationListWhereUniqueInput: ["id", "patientId_consultationDate", "AND", "OR", "NOT", "patientId", "active", "consultationDate", "createdAt", "updatedAt", "patient"],
  ConsultationListOrderByWithAggregationInput: ["id", "patientId", "active", "consultationDate", "createdAt", "updatedAt", "_count", "_max", "_min"],
  ConsultationListScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id", "patientId", "active", "consultationDate", "createdAt", "updatedAt"],
  ClinicalEventWhereInput: ["AND", "OR", "NOT", "id", "eventType", "eventCategory", "userId", "patientId", "createdAt", "updatedAt", "deleted", "deletedReport", "deletedByUserId", "dicom", "dicomId", "clinicalDiagnosticId", "user", "patient", "Prescription", "WorkingList"],
  ClinicalEventOrderByWithRelationInput: ["id", "eventType", "eventCategory", "userId", "patientId", "createdAt", "updatedAt", "deleted", "deletedReport", "deletedByUserId", "dicom", "dicomId", "clinicalDiagnosticId", "user", "patient", "Prescription", "WorkingList"],
  ClinicalEventWhereUniqueInput: ["id", "AND", "OR", "NOT", "eventType", "eventCategory", "userId", "patientId", "createdAt", "updatedAt", "deleted", "deletedReport", "deletedByUserId", "dicom", "dicomId", "clinicalDiagnosticId", "user", "patient", "Prescription", "WorkingList"],
  ClinicalEventOrderByWithAggregationInput: ["id", "eventType", "eventCategory", "userId", "patientId", "createdAt", "updatedAt", "deleted", "deletedReport", "deletedByUserId", "dicom", "dicomId", "clinicalDiagnosticId", "_count", "_max", "_min"],
  ClinicalEventScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id", "eventType", "eventCategory", "userId", "patientId", "createdAt", "updatedAt", "deleted", "deletedReport", "deletedByUserId", "dicom", "dicomId", "clinicalDiagnosticId"],
  ...
  DocumentTemplateWhereInput: ["AND", "OR", "NOT", "id", "templateName", "evenTemplateUrl", "eventDoxTemplate", "oddTemplateUrl", "oddDoxTemplate", "templateSpeciality", "createdAt"],
  DocumentTemplateOrderByWithRelationInput: ["id", "templateName", "evenTemplateUrl", "eventDoxTemplate", "oddTemplateUrl", "oddDoxTemplate", "templateSpeciality", "createdAt"],
  DocumentTemplateWhereUniqueInput: ["id", "AND", "OR", "NOT", "templateName", "evenTemplateUrl", "eventDoxTemplate", "oddTemplateUrl", "oddDoxTemplate", "templateSpeciality", "createdAt"],
  DocumentTemplateOrderByWithAggregationInput: ["id", "templateName", "evenTemplateUrl", "eventDoxTemplate", "oddTemplateUrl", "oddDoxTemplate", "templateSpeciality", "createdAt", "_count", "_avg", "_max", "_min", "_sum"],
  DocumentTemplateScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id", "templateName", "evenTemplateUrl", "eventDoxTemplate", "oddTemplateUrl", "oddDoxTemplate", "templateSpeciality", "createdAt"],
  EconomizerWhereInput: ["AND", "OR", "NOT", "id", "name", "eventType", "template"],
  EconomizerOrderByWithRelationInput: ["id", "name", "eventType", "template"],
  EconomizerWhereUniqueInput: ["id", "name", "AND", "OR", "NOT", "eventType", "template"],
  ...
  UserCreateInput: ["id", "email", "userId", "lastName", "firstName", "fullName", "avatarUrl", "role", "phoneNumbers", "lastConnection", "searchApiKeyId", "searchApiKey", "editorKey", "createdAt", "WorkingList", "ClinicalEvent"],
  UserUpdateInput: ["id", "email", "userId", "lastName", "firstName", "fullName", "avatarUrl", "role", "phoneNumbers", "lastConnection", "searchApiKeyId", "searchApiKey", "editorKey", "createdAt", "WorkingList", "ClinicalEvent"],
  ...
  SettingCreateInput: ["id", "allowedMobileDevices_doctors", "allowedMobileDevices_secretary", "allowedDICOMmodalities", "allowedEventTypes", "documentTemplateConfiguration"],
  SettingUpdateInput: ["id", "allowedMobileDevices_doctors", "allowedMobileDevices_secretary", "allowedDICOMmodalities", "allowedEventTypes", "documentTemplateConfiguration"],
  SettingCreateManyInput: ["id", "allowedMobileDevices_doctors", "allowedMobileDevices_secretary", "allowedDICOMmodalities", "allowedEventTypes", "documentTemplateConfiguration"],
  SettingUpdateManyMutationInput: ["id", "allowedMobileDevices_doctors", "allowedMobileDevices_secretary", "allowedDICOMmodalities", "allowedEventTypes", "documentTemplateConfiguration"],
  ...
  PatientCreateInput: ["id", "lastName", "firstName", "ddn", "sexe", "nTel", "address", "height", "weight", "createdAt", "updated", "deleted", "onTrash", "informationsConfirmed", "patientAvatar", "ConsultationList", "ClinicalEvent", "WorkingList", "DocumentStore", "PatientScanedDocument"],
  PatientUpdateInput: ["id", "lastName", "firstName", "ddn", "sexe", "nTel", "address", "height", "weight", "createdAt", "updated", "deleted", "onTrash", "informationsConfirmed", "patientAvatar", "ConsultationList", "ClinicalEvent", "WorkingList", "DocumentStore", "PatientScanedDocument"],
  PatientCreateManyInput: ["id", "lastName", "firstName", "ddn", "sexe", "nTel", "address", "height", "weight", "createdAt", "updated", "deleted", "onTrash", "informationsConfirmed", "patientAvatar"],
  PatientUpdateManyMutationInput: ["id", "lastName", "firstName", "ddn", "sexe", "nTel", "address", "height", "weight", "createdAt", "updated", "deleted", "onTrash", "informationsConfirmed", "patientAvatar"],
  PatientScannedDocumentCreateInput: ["id", "documentCollectionName", "documentCollectionUrls", "documentCollectionDate", "createdAt", "patient"],
  PatientScannedDocumentUpdateInput: ["id", "documentCollectionName", "documentCollectionUrls", "documentCollectionDate", "createdAt", "patient"],
  PatientScannedDocumentCreateManyInput: ["id", "documentCollectionName", "documentCollectionUrls", "documentCollectionDate", "createdAt", "patientId"],
  PatientScannedDocumentUpdateManyMutationInput: ["id", "documentCollectionName", "documentCollectionUrls", "documentCollectionDate", "createdAt"],
  DocumentStoreCreateInput: ["id", "patientDocumentType", "content", "textContent", "patient"],
  DocumentStoreUpdateInput: ["id", "patientDocumentType", "content", "textContent", "patient"],
  DocumentStoreCreateManyInput: ["id", "patientId", "patientDocumentType", "content", "textContent"],
  DocumentStoreUpdateManyMutationInput: ["id", "patientDocumentType", "content", "textContent"],
  ConsultationListCreateInput: ["id", "active", "consultationDate", "createdAt", "updatedAt", "patient"],
  ConsultationListUpdateInput: ["id", "active", "consultationDate", "createdAt", "updatedAt", "patient"],
  ConsultationListCreateManyInput: ["id", "patientId", "active", "consultationDate", "createdAt", "updatedAt"],
  ConsultationListUpdateManyMutationInput: ["id", "active", "consultationDate", "createdAt", "updatedAt"],
  ClinicalEventCreateInput: ["id", "eventType", "eventCategory", "createdAt", "updatedAt", "deleted", "deletedReport", "deletedByUserId", "dicom", "dicomId", "clinicalDiagnosticId", "user", "patient", "Prescription", "WorkingList"],
  ClinicalEventUpdateInput: ["id", "eventType", "eventCategory", "createdAt", "updatedAt", "deleted", "deletedReport", "deletedByUserId", "dicom", "dicomId", "clinicalDiagnosticId", "user", "patient", "Prescription", "WorkingList"],
  ClinicalEventCreateManyInput: ["id", "eventType", "eventCategory", "userId", "patientId", "createdAt", "updatedAt", "deleted", "deletedReport", "deletedByUserId", "dicom", "dicomId", "clinicalDiagnosticId"],
  ClinicalEventUpdateManyMutationInput: ["id", "eventType", "eventCategory", "createdAt", "updatedAt", "deleted", "deletedReport", "deletedByUserId", "dicom", "dicomId", "clinicalDiagnosticId"],
  ...
  DocumentTemplateCreateInput: ["templateName", "evenTemplateUrl", "eventDoxTemplate", "oddTemplateUrl", "oddDoxTemplate", "templateSpeciality", "createdAt"],
  DocumentTemplateUpdateInput: ["templateName", "evenTemplateUrl", "eventDoxTemplate", "oddTemplateUrl", "oddDoxTemplate", "templateSpeciality", "createdAt"],
  DocumentTemplateCreateManyInput: ["id", "templateName", "evenTemplateUrl", "eventDoxTemplate", "oddTemplateUrl", "oddDoxTemplate", "templateSpeciality", "createdAt"],
  DocumentTemplateUpdateManyMutationInput: ["templateName", "evenTemplateUrl", "eventDoxTemplate", "oddTemplateUrl", "oddDoxTemplate", "templateSpeciality", "createdAt"],
  ...
  SettingCountOrderByAggregateInput: ["id", "allowedMobileDevices_doctors", "allowedMobileDevices_secretary", "allowedDICOMmodalities", "allowedEventTypes", "documentTemplateConfiguration"],
  SettingAvgOrderByAggregateInput: ["allowedMobileDevices_doctors", "allowedMobileDevices_secretary", "allowedDICOMmodalities"],
  SettingMaxOrderByAggregateInput: ["id", "allowedMobileDevices_doctors", "allowedMobileDevices_secretary", "allowedDICOMmodalities", "documentTemplateConfiguration"],
  SettingMinOrderByAggregateInput: ["id", "allowedMobileDevices_doctors", "allowedMobileDevices_secretary", "allowedDICOMmodalities", "documentTemplateConfiguration"],
  ...
  DocumentStoreListRelationFilter: ["every", "some", "none"],
  PatientScannedDocumentListRelationFilter: ["every", "some", "none"],
  ConsultationListOrderByRelationAggregateInput: ["_count"],
  DocumentStoreOrderByRelationAggregateInput: ["_count"],
  PatientScannedDocumentOrderByRelationAggregateInput: ["_count"],
  PatientCountOrderByAggregateInput: ["id", "lastName", "firstName", "ddn", "sexe", "nTel", "address", "height", "weight", "createdAt", "updated", "deleted", "onTrash", "informationsConfirmed", "patientAvatar"],
  PatientAvgOrderByAggregateInput: ["height", "weight"],
  PatientMaxOrderByAggregateInput: ["id", "lastName", "firstName", "ddn", "sexe", "nTel", "address", "height", "weight", "createdAt", "updated", "deleted", "onTrash", "informationsConfirmed", "patientAvatar"],
  PatientMinOrderByAggregateInput: ["id", "lastName", "firstName", "ddn", "sexe", "nTel", "address", "height", "weight", "createdAt", "updated", "deleted", "onTrash", "informationsConfirmed", "patientAvatar"],
  ...
  PatientScannedDocumentCountOrderByAggregateInput: ["id", "documentCollectionName", "documentCollectionUrls", "documentCollectionDate", "createdAt", "patientId"],
  PatientScannedDocumentMaxOrderByAggregateInput: ["id", "documentCollectionName", "documentCollectionDate", "createdAt", "patientId"],
  PatientScannedDocumentMinOrderByAggregateInput: ["id", "documentCollectionName", "documentCollectionDate", "createdAt", "patientId"],
  EnumPatientDocumentTypeFilter: ["equals", "in", "notIn", "not"],
  BytesNullableFilter: ["equals", "in", "notIn", "not"],
  DocumentStorePatientIdPatientDocumentTypeCompoundUniqueInput: ["patientId", "patientDocumentType"],
  DocumentStoreCountOrderByAggregateInput: ["id", "patientId", "patientDocumentType", "content", "textContent"],
  DocumentStoreMaxOrderByAggregateInput: ["id", "patientId", "patientDocumentType", "content", "textContent"],
  DocumentStoreMinOrderByAggregateInput: ["id", "patientId", "patientDocumentType", "content", "textContent"],
  EnumPatientDocumentTypeWithAggregatesFilter: ["equals", "in", "notIn", "not", "_count", "_min", "_max"],
  BytesNullableWithAggregatesFilter: ["equals", "in", "notIn", "not", "_count", "_min", "_max"],
  ConsultationListPatientIdConsultationDateCompoundUniqueInput: ["patientId", "consultationDate"],
  ConsultationListCountOrderByAggregateInput: ["id", "patientId", "active", "consultationDate", "createdAt", "updatedAt"],
  ConsultationListMaxOrderByAggregateInput: ["id", "patientId", "active", "consultationDate", "createdAt", "updatedAt"],
  ConsultationListMinOrderByAggregateInput: ["id", "patientId", "active", "consultationDate", "createdAt", "updatedAt"],
  EnumEventTypesFilter: ["equals", "in", "notIn", "not"],
  EnumEventCategoryFilter: ["equals", "in", "notIn", "not"],
  UserRelationFilter: ["is", "isNot"],
  PrescriptionNullableRelationFilter: ["is", "isNot"],
  ClinicalEventCountOrderByAggregateInput: ["id", "eventType", "eventCategory", "userId", "patientId", "createdAt", "updatedAt", "deleted", "deletedReport", "deletedByUserId", "dicom", "dicomId", "clinicalDiagnosticId"],
  ClinicalEventMaxOrderByAggregateInput: ["id", "eventType", "eventCategory", "userId", "patientId", "createdAt", "updatedAt", "deleted", "deletedReport", "deletedByUserId", "dicom", "dicomId", "clinicalDiagnosticId"],
  ClinicalEventMinOrderByAggregateInput: ["id", "eventType", "eventCategory", "userId", "patientId", "createdAt", "updatedAt", "deleted", "deletedReport", "deletedByUserId", "dicom", "dicomId", "clinicalDiagnosticId"],
  EnumEventTypesWithAggregatesFilter: ["equals", "in", "notIn", "not", "_count", "_min", "_max"],
  EnumEventCategoryWithAggregatesFilter: ["equals", "in", "notIn", "not", "_count", "_min", "_max"],
  ...
  EnumTemplateSpecialityFilter: ["equals", "in", "notIn", "not"],
  DocumentTemplateCountOrderByAggregateInput: ["id", "templateName", "evenTemplateUrl", "eventDoxTemplate", "oddTemplateUrl", "oddDoxTemplate", "templateSpeciality", "createdAt"],
  DocumentTemplateAvgOrderByAggregateInput: ["id"],
  DocumentTemplateMaxOrderByAggregateInput: ["id", "templateName", "evenTemplateUrl", "eventDoxTemplate", "oddTemplateUrl", "oddDoxTemplate", "templateSpeciality", "createdAt"],
  DocumentTemplateMinOrderByAggregateInput: ["id", "templateName", "evenTemplateUrl", "eventDoxTemplate", "oddTemplateUrl", "oddDoxTemplate", "templateSpeciality", "createdAt"],
  DocumentTemplateSumOrderByAggregateInput: ["id"],
  EnumTemplateSpecialityWithAggregatesFilter: ["equals", "in", "notIn", "not", "_count", "_min", "_max"],
  ...
  DocumentStoreCreateNestedManyWithoutPatientInput: ["create", "connectOrCreate", "createMany", "connect"],
  PatientScannedDocumentCreateNestedManyWithoutPatientInput: ["create", "connectOrCreate", "createMany", "connect"],
  ...
  DocumentStoreUpdateManyWithoutPatientNestedInput: ["create", "connectOrCreate", "upsert", "createMany", "set", "disconnect", "delete", "connect", "update", "updateMany", "deleteMany"],
  PatientScannedDocumentUpdateManyWithoutPatientNestedInput: ["create", "connectOrCreate", "upsert", "createMany", "set", "disconnect", "delete", "connect", "update", "updateMany", "deleteMany"],
  PatientScannedDocumentCreatedocumentCollectionUrlsInput: ["set"],
  PatientCreateNestedOneWithoutPatientScanedDocumentInput: ["create", "connectOrCreate", "connect"],
  PatientScannedDocumentUpdatedocumentCollectionUrlsInput: ["set", "push"],
  PatientUpdateOneRequiredWithoutPatientScanedDocumentNestedInput: ["create", "connectOrCreate", "upsert", "connect", "update"],
  PatientCreateNestedOneWithoutDocumentStoreInput: ["create", "connectOrCreate", "connect"],
  EnumPatientDocumentTypeFieldUpdateOperationsInput: ["set"],
  NullableBytesFieldUpdateOperationsInput: ["set"],
  PatientUpdateOneRequiredWithoutDocumentStoreNestedInput: ["create", "connectOrCreate", "upsert", "connect", "update"],
  ...
  EnumEventCategoryFieldUpdateOperationsInput: ["set"],
  ...
  EnumTemplateSpecialityFieldUpdateOperationsInput: ["set"],
  ...
  NestedEnumPatientDocumentTypeFilter: ["equals", "in", "notIn", "not"],
  NestedBytesNullableFilter: ["equals", "in", "notIn", "not"],
  NestedEnumPatientDocumentTypeWithAggregatesFilter: ["equals", "in", "notIn", "not", "_count", "_min", "_max"],
  ...
  NestedEnumEventCategoryFilter: ["equals", "in", "notIn", "not"],
  NestedEnumEventTypesWithAggregatesFilter: ["equals", "in", "notIn", "not", "_count", "_min", "_max"],
  NestedEnumEventCategoryWithAggregatesFilter: ["equals", "in", "notIn", "not", "_count", "_min", "_max"],
  ...
  NestedEnumTemplateSpecialityFilter: ["equals", "in", "notIn", "not"],
  NestedEnumTemplateSpecialityWithAggregatesFilter: ["equals", "in", "notIn", "not", "_count", "_min", "_max"],
  ...
  ClinicalEventCreateWithoutUserInput: ["id", "eventType", "eventCategory", "createdAt", "updatedAt", "deleted", "deletedReport", "deletedByUserId", "dicom", "dicomId", "clinicalDiagnosticId", "patient", "Prescription", "WorkingList"],
  ...
  ClinicalEventScalarWhereInput: ["AND", "OR", "NOT", "id", "eventType", "eventCategory", "userId", "patientId", "createdAt", "updatedAt", "deleted", "deletedReport", "deletedByUserId", "dicom", "dicomId", "clinicalDiagnosticId"],
  ConsultationListCreateWithoutPatientInput: ["id", "active", "consultationDate", "createdAt", "updatedAt"],
  ...
  ClinicalEventCreateWithoutPatientInput: ["id", "eventType", "eventCategory", "createdAt", "updatedAt", "deleted", "deletedReport", "deletedByUserId", "dicom", "dicomId", "clinicalDiagnosticId", "user", "Prescription", "WorkingList"],
  ...
  DocumentStoreCreateWithoutPatientInput: ["id", "patientDocumentType", "content", "textContent"],
  DocumentStoreCreateOrConnectWithoutPatientInput: ["where", "create"],
  DocumentStoreCreateManyPatientInputEnvelope: ["data", "skipDuplicates"],
  PatientScannedDocumentCreateWithoutPatientInput: ["id", "documentCollectionName", "documentCollectionUrls", "documentCollectionDate", "createdAt"],
  PatientScannedDocumentCreateOrConnectWithoutPatientInput: ["where", "create"],
  PatientScannedDocumentCreateManyPatientInputEnvelope: ["data", "skipDuplicates"],
  ...
  ConsultationListScalarWhereInput: ["AND", "OR", "NOT", "id", "patientId", "active", "consultationDate", "createdAt", "updatedAt"],
  ...
  DocumentStoreUpsertWithWhereUniqueWithoutPatientInput: ["where", "update", "create"],
  DocumentStoreUpdateWithWhereUniqueWithoutPatientInput: ["where", "data"],
  DocumentStoreUpdateManyWithWhereWithoutPatientInput: ["where", "data"],
  DocumentStoreScalarWhereInput: ["AND", "OR", "NOT", "id", "patientId", "patientDocumentType", "content", "textContent"],
  PatientScannedDocumentUpsertWithWhereUniqueWithoutPatientInput: ["where", "update", "create"],
  PatientScannedDocumentUpdateWithWhereUniqueWithoutPatientInput: ["where", "data"],
  PatientScannedDocumentUpdateManyWithWhereWithoutPatientInput: ["where", "data"],
  PatientScannedDocumentScalarWhereInput: ["AND", "OR", "NOT", "id", "documentCollectionName", "documentCollectionUrls", "documentCollectionDate", "createdAt", "patientId"],
  PatientCreateWithoutPatientScanedDocumentInput: ["id", "lastName", "firstName", "ddn", "sexe", "nTel", "address", "height", "weight", "createdAt", "updated", "deleted", "onTrash", "informationsConfirmed", "patientAvatar", "ConsultationList", "ClinicalEvent", "WorkingList", "DocumentStore"],
  PatientCreateOrConnectWithoutPatientScanedDocumentInput: ["where", "create"],
  PatientUpsertWithoutPatientScanedDocumentInput: ["update", "create", "where"],
  PatientUpdateToOneWithWhereWithoutPatientScanedDocumentInput: ["where", "data"],
  PatientUpdateWithoutPatientScanedDocumentInput: ["id", "lastName", "firstName", "ddn", "sexe", "nTel", "address", "height", "weight", "createdAt", "updated", "deleted", "onTrash", "informationsConfirmed", "patientAvatar", "ConsultationList", "ClinicalEvent", "WorkingList", "DocumentStore"],
  PatientCreateWithoutDocumentStoreInput: ["id", "lastName", "firstName", "ddn", "sexe", "nTel", "address", "height", "weight", "createdAt", "updated", "deleted", "onTrash", "informationsConfirmed", "patientAvatar", "ConsultationList", "ClinicalEvent", "WorkingList", "PatientScanedDocument"],
  PatientCreateOrConnectWithoutDocumentStoreInput: ["where", "create"],
  PatientUpsertWithoutDocumentStoreInput: ["update", "create", "where"],
  PatientUpdateToOneWithWhereWithoutDocumentStoreInput: ["where", "data"],
  PatientUpdateWithoutDocumentStoreInput: ["id", "lastName", "firstName", "ddn", "sexe", "nTel", "address", "height", "weight", "createdAt", "updated", "deleted", "onTrash", "informationsConfirmed", "patientAvatar", "ConsultationList", "ClinicalEvent", "WorkingList", "PatientScanedDocument"],
  PatientCreateWithoutConsultationListInput: ["id", "lastName", "firstName", "ddn", "sexe", "nTel", "address", "height", "weight", "createdAt", "updated", "deleted", "onTrash", "informationsConfirmed", "patientAvatar", "ClinicalEvent", "WorkingList", "DocumentStore", "PatientScanedDocument"],
  ...
  PatientUpdateWithoutConsultationListInput: ["id", "lastName", "firstName", "ddn", "sexe", "nTel", "address", "height", "weight", "createdAt", "updated", "deleted", "onTrash", "informationsConfirmed", "patientAvatar", "ClinicalEvent", "WorkingList", "DocumentStore", "PatientScanedDocument"],
  ...
  PatientCreateWithoutClinicalEventInput: ["id", "lastName", "firstName", "ddn", "sexe", "nTel", "address", "height", "weight", "createdAt", "updated", "deleted", "onTrash", "informationsConfirmed", "patientAvatar", "ConsultationList", "WorkingList", "DocumentStore", "PatientScanedDocument"],
  ...
  PatientUpdateWithoutClinicalEventInput: ["id", "lastName", "firstName", "ddn", "sexe", "nTel", "address", "height", "weight", "createdAt", "updated", "deleted", "onTrash", "informationsConfirmed", "patientAvatar", "ConsultationList", "WorkingList", "DocumentStore", "PatientScanedDocument"],
  ...
  ClinicalEventCreateWithoutPrescriptionInput: ["id", "eventType", "eventCategory", "createdAt", "updatedAt", "deleted", "deletedReport", "deletedByUserId", "dicom", "dicomId", "clinicalDiagnosticId", "user", "patient", "WorkingList"],
  ...
  ClinicalEventUpdateWithoutPrescriptionInput: ["id", "eventType", "eventCategory", "createdAt", "updatedAt", "deleted", "deletedReport", "deletedByUserId", "dicom", "dicomId", "clinicalDiagnosticId", "user", "patient", "WorkingList"],
  ...
  PatientCreateWithoutWorkingListInput: ["id", "lastName", "firstName", "ddn", "sexe", "nTel", "address", "height", "weight", "createdAt", "updated", "deleted", "onTrash", "informationsConfirmed", "patientAvatar", "ConsultationList", "ClinicalEvent", "DocumentStore", "PatientScanedDocument"],
  ...
  ClinicalEventCreateWithoutWorkingListInput: ["id", "eventType", "eventCategory", "createdAt", "updatedAt", "deleted", "deletedReport", "deletedByUserId", "dicom", "dicomId", "clinicalDiagnosticId", "user", "patient", "Prescription"],
  ...
  PatientUpdateWithoutWorkingListInput: ["id", "lastName", "firstName", "ddn", "sexe", "nTel", "address", "height", "weight", "createdAt", "updated", "deleted", "onTrash", "informationsConfirmed", "patientAvatar", "ConsultationList", "ClinicalEvent", "DocumentStore", "PatientScanedDocument"],
  ...
  ClinicalEventUpdateWithoutWorkingListInput: ["id", "eventType", "eventCategory", "createdAt", "updatedAt", "deleted", "deletedReport", "deletedByUserId", "dicom", "dicomId", "clinicalDiagnosticId", "user", "patient", "Prescription"],
  ...
  ClinicalEventCreateManyUserInput: ["id", "eventType", "eventCategory", "patientId", "createdAt", "updatedAt", "deleted", "deletedReport", "deletedByUserId", "dicom", "dicomId", "clinicalDiagnosticId"],
  ...
  ClinicalEventUpdateWithoutUserInput: ["id", "eventType", "eventCategory", "createdAt", "updatedAt", "deleted", "deletedReport", "deletedByUserId", "dicom", "dicomId", "clinicalDiagnosticId", "patient", "Prescription", "WorkingList"],
  ConsultationListCreateManyPatientInput: ["id", "active", "consultationDate", "createdAt", "updatedAt"],
  ClinicalEventCreateManyPatientInput: ["id", "eventType", "eventCategory", "userId", "createdAt", "updatedAt", "deleted", "deletedReport", "deletedByUserId", "dicom", "dicomId", "clinicalDiagnosticId"],
  ...
  DocumentStoreCreateManyPatientInput: ["id", "patientDocumentType", "content", "textContent"],
  PatientScannedDocumentCreateManyPatientInput: ["id", "documentCollectionName", "documentCollectionUrls", "documentCollectionDate", "createdAt"],
  ConsultationListUpdateWithoutPatientInput: ["id", "active", "consultationDate", "createdAt", "updatedAt"],
  ClinicalEventUpdateWithoutPatientInput: ["id", "eventType", "eventCategory", "createdAt", "updatedAt", "deleted", "deletedReport", "deletedByUserId", "dicom", "dicomId", "clinicalDiagnosticId", "user", "Prescription", "WorkingList"],
  ...
  DocumentStoreUpdateWithoutPatientInput: ["id", "patientDocumentType", "content", "textContent"],
  PatientScannedDocumentUpdateWithoutPatientInput: ["id", "documentCollectionName", "documentCollectionUrls", "documentCollectionDate", "createdAt"],
