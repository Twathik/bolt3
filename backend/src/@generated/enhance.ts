...
const modelsInfo = {
  ...
  DocumentStore: ["id", "patientId", "patientDocumentType", "content"],
...
const outputsInfo = {
  ...
  DocumentStoreGroupBy: ["id", "patientId", "patientDocumentType", "content", "_count", "_min", "_max"],
  ...
  DocumentStoreCountAggregate: ["id", "patientId", "patientDocumentType", "content", "_all"],
  DocumentStoreMinAggregate: ["id", "patientId", "patientDocumentType", "content"],
  DocumentStoreMaxAggregate: ["id", "patientId", "patientDocumentType", "content"],
...
const inputsInfo = {
  ...
  DocumentStoreWhereInput: ["AND", "OR", "NOT", "id", "patientId", "patientDocumentType", "content"],
  DocumentStoreOrderByWithRelationInput: ["id", "patientId", "patientDocumentType", "content"],
  DocumentStoreWhereUniqueInput: ["id", "patientId", "AND", "OR", "NOT", "patientDocumentType", "content"],
  DocumentStoreOrderByWithAggregationInput: ["id", "patientId", "patientDocumentType", "content", "_count", "_max", "_min"],
  DocumentStoreScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id", "patientId", "patientDocumentType", "content"],
  ...
  DocumentStoreCreateInput: ["id", "patientId", "patientDocumentType", "content"],
  DocumentStoreUpdateInput: ["id", "patientId", "patientDocumentType", "content"],
  DocumentStoreCreateManyInput: ["id", "patientId", "patientDocumentType", "content"],
  DocumentStoreUpdateManyMutationInput: ["id", "patientId", "patientDocumentType", "content"],
  ...
  DocumentStoreCountOrderByAggregateInput: ["id", "patientId", "patientDocumentType", "content"],
  DocumentStoreMaxOrderByAggregateInput: ["id", "patientId", "patientDocumentType", "content"],
  DocumentStoreMinOrderByAggregateInput: ["id", "patientId", "patientDocumentType", "content"],
