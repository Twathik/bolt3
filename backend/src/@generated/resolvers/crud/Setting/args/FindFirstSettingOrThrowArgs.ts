...
export class FindFirstSettingOrThrowArgs {
  ...
  distinct?: Array<"id" | "allowedMobileDevices_doctors" | "allowedMobileDevices_secretary" | "allowedDICOMmodalities" | "allowedEventTypes" | "documentTemplateConfiguration"> | undefined;
}
