...
import { NestedEnumSexeWithAggregatesFilterObjectSchema } from './NestedEnumSexeWithAggregatesFilter.schema'
import { NestedIntFilterObjectSchema } from './NestedIntFilter.schema'
import { NestedEnumSexeFilterObjectSchema } from './NestedEnumSexeFilter.schema'

import type { Prisma } from '@prisma/client'

const Schema: z.ZodType<Prisma.EnumSexeWithAggregatesFilter> = z
  .object({
...
export const EnumSexeWithAggregatesFilterObjectSchema = Schema
